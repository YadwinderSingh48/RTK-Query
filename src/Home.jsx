...
import { useAddTaskMutation, useGetTasksQuery } from "./redux/task-api-slice";
...
export default function Home() {
  ...
  const {data: tasksList,error,isError, isLoading} = useGetTasksQuery();
